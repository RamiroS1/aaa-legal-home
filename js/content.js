...
/* Client logos — local transparent PNGs (plate: keep dark bg) */
const CLIENT_LOGOS = [
  { src: "clientes/00-cliente.png", alt: "Cliente" },
  { src: "clientes/01-nitrofer.png", alt: "Nitrofer" },
  { src: "clientes/02-cliente.png", alt: "Cliente" },
  { src: "clientes/03-cliente.png", alt: "Cliente" },
  { src: "clientes/04-condival.png", alt: "Condival" },
  { src: "clientes/05-edicom.png", alt: "Edicom" },
  { src: "clientes/06-idime.png", alt: "Idime" },
  { src: "clientes/07-cnr.png", alt: "CNR" },
  { src: "clientes/08-carder.png", alt: "Carder" },
  { src: "clientes/09-petromil.png", alt: "Petromil" },
  { src: "clientes/10-novamed.png", alt: "Novamed" },
  { src: "clientes/11-npv.png", alt: "NPV" },
  { src: "clientes/12-ols.png", alt: "OLS" },
  { src: "clientes/13-pmb.png", alt: "PMB" },
  { src: "clientes/14-upc.png", alt: "UPC" },
  { src: "clientes/15-ecos.png", alt: "Ecos" },
  { src: "clientes/16-baobab.png", alt: "Baobab" },
  { src: "clientes/17-comce.png", alt: "COMCE" },
  { src: "clientes/18-super-giros.png", alt: "Super Giros" },
  { src: "clientes/19-nitron.png", alt: "Nitron" },
  { src: "clientes/20-puntored.png", alt: "Puntored" },
  { src: "clientes/21-land-rental.png", alt: "Land Rental", plate: true },
